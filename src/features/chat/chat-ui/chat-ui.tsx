...
export const ChatUI: FC<Prop> = (props) => {
    ...
    const { resetToBottom } = useChatScrollAnchor(messages, scrollRef);
    ...
    const onHandleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        handleSubmit(e);
        resetToBottom(); // Reset scroll to bottom when a new prompt is submitted
    };
                    ...
                    <ChatRow
                        ...
                        profilePicture={
                            message.role === "user"
                                ? session?.user?.image!
                                : theme === "dark"
                                ? "/CreativeGPTlogo-light.png"
                                : "/CreativeGPTlogo-dark.png"
                        }
